...
public class Confitura2018 {
    ...
    @FindBy(css = "body > ui-view > ui-view > div > div:nth-child(2) > div:nth-child(2) > div.col-md-7 > div > ul > li:nth-child(1)")
    ...
    public static String addComment()
    {
        ...
        Star5.click();
        commentField.clear();
        commentField.sendKeys("gruszki na wierzbie ółśćąźężń&*))%@@@11666==~~");
        logger.info("comment typed");
        addComment.click();
        WaitForElement.waitUntilElementIsVisible(addedComment);
        String comment=addedComment.getText();
